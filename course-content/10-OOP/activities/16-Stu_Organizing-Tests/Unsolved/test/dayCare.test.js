...
describe("DayCare", () => {
  describe("Initialization", () => {
    it("should create an object with 'children' array, 'capacity' number, and 'ageLimit' number", () => {
      ...
      // We are expecting the Daycare to have the following values
  ...
  describe("addChild", () => {
    it("should add a child to the 'children' array", () => {
      ...
      // We are creating a new child and new daycare
      const child = new Child("Tammy", 1);
      const dayCare = new DayCare();

      // TODO: Add a comment describing the purpose of the following method
      // we are adding that child to the daycare
      dayCare.addChild(child);

      // TODO: Add a comment describing the purpose of the following statements
      // We are then expecting one child to be in this daycare and the child to be the one at position zero
    ...
    it("should not add a child over the 'ageLimit'", () => {
      ...
      // TODO: Add a comment describing the purpose of the following statement
      // If we try to add a child over the age of 6, this child will not be added 
    ...
    it("should not add a child if already at capacity", () => {
      ...
      //  We are starting the daycare with 3 children already in it
      dayCare.children = [
        new Child("Tammy", 1),
        new Child("Mark", 2),
        new Child("Alvin", 1)
      ...
      // TODO: Add a comment describing the purpose of the following statement
//  If we try to add a child past the capacity, this child will not be added
    ...
    it("should throw an error if not provided a Child object as an argument", () => {
      ...
      // TODO: Add a comment describing the purpose of the following expression
      // We are adding an undefined child to be hte call back function 
      const cb = () => {
        const dayCare = new DayCare();
        dayCare.addChild();
      };
      ...
      // TODO: Add a comment describing the purpose of the following statement
      // for adding a undefined child, we should throw an error
  ...
  describe("pickupChild", () => {
    it("should remove the first child found with a given name from 'children' and return it", () => {
      ...
      // TODO: Add a comment describing the purpose of the following declaration
      // we are creating a variable to remove child2
      ...
      // TODO: Add a comment describing the purpose of the following statement
      // If after removing child2 from daycare, if any of the children have the same name as child2 we return false.
      // 
      expect(
