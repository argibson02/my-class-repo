...
// A: We for to interatre through the unsortedArr  
// Q: How are you going to do it?
// A: For loop
// Q: Why are you going to do it?
// A: need to do this ingest array content

// Step Two:
// Q: What are you going to do?
// A: create a function that compare values in the array and determines which one is greater
// Q: How are you going to do it?
// A: For each, have a function compare the value at index i to the value at index i+1
// Q: Why are you going to do it?
// A: we need to determine which on item is greater

// Step Three:
// Q: What are you going to do?
// A: swap posistion in the array if the right in one is less than the left
// Q: How are you going to do it?
// A: If the index i+1 is less than index i, we will swap the termpeorray variable that allows to saefly transfer the two indeces values with each each other
// Q: Why are you going to do it?
// A: this swaps the two values
