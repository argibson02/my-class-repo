...
// This on eit just gettign things from /api/terms
app.get('/api/terms/', (req, res) => {
  // TODO: Add a comment describing the req.query object
// Making sure that hte object of keys has a length greater than 0 so that we dont run on empty
...
// getting things from our object with a key of term
app.get('/api/term/:something', (req, res) => {
  // TODO: Add a comment describing the content of req.params in this instance
// taking the term and chagin to lowercase
...
// TODO: Add a comment describing what this route will return
// return the content in category object
...
// TODO: Add a comment describing what this route will return
// This one would just return a 404? Returns an empty object?
