...
// converting review into a json string with some error catches
const postReview = (review) =>
  ...
  // need review/reposns.body, method, and headcontent
  fetch('/api/reviews', {
    method: 'POST',
    headers: {
    ...
    // so that it is readable for a fetch
    ...
    // this is an error catch for the then statement above
    .catch((error) => {
