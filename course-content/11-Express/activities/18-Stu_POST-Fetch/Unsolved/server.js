...
app.post('/api/reviews', (req, res) => {
  ...
  // This is deconstrucitong the response object
  ...
  // Becuase this is error checking that we dont add any null values
  if (product && review && username) {
    ...
    // that is converting our object into a json string

    res.json(response);
  } else {
    // TODO: Add a comment describing the purpose of the else statement in this POST request.
    // Error checking if there were to be problem in covnerting to a json string
