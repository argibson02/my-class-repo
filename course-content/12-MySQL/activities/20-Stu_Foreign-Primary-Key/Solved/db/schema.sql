...
SELECT products.id, products.category_name, products.price, categories.description FROM products INNER JOIN categories ON products.category_name = categories.category_name;
